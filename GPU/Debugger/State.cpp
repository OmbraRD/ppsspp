...
// Moved out of Windows/GEDebugger/TabState.cpp: GPU/Debugger/State.h declares these
// extern for every platform, but they were only ever defined in a Windows-only
// translation unit, so anything outside Windows referencing them failed to link.
